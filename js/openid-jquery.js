...
var openid = {
    ...
    init: function(input_id) {
        providers = jQuery.extend({}, providers_large, providers_small);
        ...
        jQuery(this.form_id).submit(this.submit);
    ...
    setOpenIdUrl: function (url) {
    	...
    	if (hidden != null) {
    		...
    		jQuery(this.form_id).append('<input type="hidden" id="' + this.input_id + '" name="' + this.input_id + '" value="'+url+'"/>');
    	}
    },
    ...
    useInputBox: function (provider) {
		...
		html += '<input id="'+id+'" type="text" class="input" style="'+style+'" name="'+id+'" value="'+value+'" />' + '</label></p>';
